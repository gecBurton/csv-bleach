...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "�",
            '17937, "NAA01", "Clinic", "UNKNOWN", "Visible", false, "St Chads Clinic", "St. Chads Drive", null, null, "Liverpool", "Merseyside", "L32 8RE", 53.482593536376953, -2.8844137191772461, null, null, null, null',
            19,
        ),
        (',"kevin"\n', ",", 'null, "kevin"', 2),
    ],
